...
internal static class SolverController
{
        ...
        out IReadOnlyList<PlanCardChoice>? choices)
    {
        ...
        // The final searched EndTurn can contain native setup choices without a
        // playable continuation. Consume those choices before RequestSearch can
        // observe the new Play state and handle the exhausted search horizon.
